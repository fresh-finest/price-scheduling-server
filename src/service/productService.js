...
//  }
// }
exports.filterProductBySaleUnitWithDay = async (dayFilter, unitCondition, userInput, page = 1, limit = 20) => {
    try {
        // Fetch all products
        const products = await SaleStock.find();
...
exports.filterProductByStock = async (stockCondition, userInput, page = 1, limit = 20) => {
    try {
...
exports.filterBySkuAndStatus = async (page = 1, limit = 20) => {
    ...
    try {
        ...
        throw new Error("Error while filtering and paginating SaleStock data: " + error.message);
    }
};

exports.filterSortAndPaginateSaleStock = async (sortOrder = "asc", page = 1, limit = 20) => {
    try {
